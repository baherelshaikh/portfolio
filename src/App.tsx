...
function App() {
  ...
  { name: 'Express.js', icon: Route, level: 90 },
  { name: 'JavaScript', icon: FileCode, level: 95 },
  { name: 'TypeScript', icon: FileType, level: 95 },
  { name: 'Python', icon: Terminal, level: 80 },
  { name: 'Java', icon: Coffee, level: 85 },
  { name: 'C++', icon: Terminal, level: 85 },
  { name: 'REST', icon: Cloud, level: 85 },
  { name: 'Microservices', icon: Boxes, level: 85 },
  { name: 'Socket.io', icon: Wifi, level: 85 },
  { name: 'SQL Databases', icon: Database, level: 88 },
  { name: 'NoSQL Databases', icon: Table, level: 85 },
  { name: 'Redis', icon: Flame, level: 85 },
  { name: 'ORM/Sequelize', icon: Rows, level: 85 },
  { name: 'ODM/Mongoose', icon: Leaf, level: 85 },
  { name: 'joi', icon: CheckCircle, level: 85 },
  { name: 'Express Validator', icon: ShieldCheck, level: 85 },
  { name: 'RabbitMQ', icon: MessageSquare, level: 90 },
  { name: 'Worker Threads', icon: Cpu, level: 90 },
  { name: 'Docker', icon: Box, level: 90 },
  { name: 'CI/CD', icon: Repeat, level: 90 },
  { name: 'GitHub Actions', icon: PlayCircle, level: 90 },
  { name: 'Microsoft Azure', icon: CloudLightning, level: 90 },
  { name: 'OWASP', icon: ShieldAlert, level: 90 },
  { name: 'JWT', icon: Key, level: 90 },
  { name: 'RBAC', icon: Lock, level: 90 },
  { name: 'Rate Limiting', icon: Gauge, level: 90 },
  { name: 'Jest', icon: Beaker, level: 90 },
  { name: 'Supertest', icon: FlaskConical, level: 90 },
  { name: 'Postman', icon: Send, level: 90 },
  { name: 'Winston', icon: FileText, level: 90 },
  { name: 'Swagger', icon: BookOpenText, level: 90 },
  ...
  //   { name: 'REST', icon: Code, level: 85 },
  //   { name: 'microservices', icon: Code, level: 85 },
  //   { name: 'Socket.io', icon: Code, level: 85 },
  //   { name: 'SQL Databases', icon: Database, level: 88 },
  //   { name: 'NoSQL Databases', icon: Database, level: 85 },
  //   { name: 'Redis', icon: Database, level: 85 },
  //   { name: 'ORM/Sequelize', icon: Database, level: 85 },
  //   { name: 'ODM/Mongoose', icon: Database, level: 85 },
  //   { name: 'joi', icon: Database, level: 85 },
  //   { name: 'Express Validator', icon: Database, level: 85 },
  //   { name: 'RabbitMQ', icon: Github, level: 90 },
  //   { name: 'worker threads', icon: Github, level: 90 },
  //   { name: 'Docker', icon: Github, level: 90 },
  //   { name: 'CI/CD', icon: Github, level: 90 },
  //   { name: 'GitHub Actions', icon: Github, level: 90 },
  //   { name: 'Microsoft Azure', icon: Github, level: 90 },
  //   { name: 'OWASP', icon: Github, level: 90 },
  //   { name: 'JWT', icon: Github, level: 90 },
  //   { name: 'RBAC', icon: Github, level: 90 },
  //   { name: 'rate limiting', icon: Github, level: 90 },
  //   { name: 'Jest', icon: Github, level: 90 },
  //   { name: 'Supertest', icon: Github, level: 90 },
  //   { name: 'Postman', icon: Github, level: 90 },
  //   { name: 'Winston', icon: Github, level: 90 },
  //   { name: 'Swagger', icon: Github, level: 90 },
  ...
  const education = {
    ...
    'In-depth understanding of low-level systems concepts including Digital Logic Design, Memory Management, and Computation Theory.',
    ...
    'Focus on user-centric design and interaction principles through Human-Computer Interaction (HCI) coursework and projects.',
